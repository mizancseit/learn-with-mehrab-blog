...
onMounted(async () => {
    selected_categories.value.push(props.singlecategory.id)
...
const getCourse = async () => {
    loading.value = true;
    await Axios.get('/get-course?category_ids='+JSON.stringify(selected_categories.value)+'&level_ids='+JSON.stringify(selected_levels.value)+'&type_ids='+JSON.stringify(selected_types.value)+'&limit='+selected_limit.value).then((response) => {
...
<!--            <h5 class="course-category-header">All courses </h5>-->



<!--&lt;!&ndash;            <label>&ndash;&gt;-->
<!--&lt;!&ndash;            Show Item:&ndash;&gt;-->
<!--&lt;!&ndash;            <select class="form-select course-category-dropdown w-auto">&ndash;&gt;-->
<!--&lt;!&ndash;                <option selected>১১ টি আইটেম</option>&ndash;&gt;-->
<!--&lt;!&ndash;                <option>২০ টি</option>&ndash;&gt;-->
<!--&lt;!&ndash;                <option>৩০ টি</option>&ndash;&gt;-->
<!--&lt;!&ndash;            </select>&ndash;&gt;-->
<!--&lt;!&ndash;            </label>&ndash;&gt;-->
<!--        </div>-->
<!--        <hr style="border-color: dimgray;margin-top: 3px"/>-->
