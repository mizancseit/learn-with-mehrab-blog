...
@section('title','About Data Recovery BD')
@section('meta_keyword','About Data Recovery BD')
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-10">
                    <div class="contents text-center">
                        <h2 class="wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">About Us</h2>
                        <p class="white-text-color">About our company.</p>
                    </div>
                </div>
            </div>
        </div>
