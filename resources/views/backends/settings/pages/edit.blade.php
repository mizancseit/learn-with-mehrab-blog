                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="content" class="form-control-sm form-control" placeholder="Enter Description" rows="5">{{$data->content ? $data->content: old('content')}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('meta_keyword')) error-border-for-validation @endif" placeholder="Enter meta keyword" name="meta_keyword" value="{{$data->meta_keyword ? $data->meta_keyword: old('meta_keyword')}}" >
                            </div>

                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    <label class="form-label">Meta Description</label>
                                    <textarea name="meta_description" class="form-control-sm form-control" placeholder="Enter Meta Description" rows="5">{{$data->meta_description ? $data->meta_description: old('meta_description')}}</textarea>
                                </div>
                            </div>
