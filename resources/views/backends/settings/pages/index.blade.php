                ...
                <form action="{{route('pages.index')}}" method="get">
                    <div class="row">
                        ...
                        <div class="col-4 offset-2" style="text-align: right">
                            <a  href="{{route('pages.create')}}" class="btn btn-outline-primary" style="padding: 0.5rem 1rem;"><i class="fa-solid fa-plus"></i> Add</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table header-border table-responsive-sm">
                        ...
                        @foreach($datas as $k => $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('pages.edit',$data->id)}}"><span class="badge badge-info"><i class="fa-solid fa-pen-to-square"></i></span></a>
                                    <button type="button" class="badge badge-danger" data-bs-toggle="modal" data-bs-target="#destroyModal" data-id="{{$data->id}}" data-action="{{route('pages.destroy',$data->id)}}"><i class="fa-solid fa-trash"></i></button>
                                </td>
                            </tr>
                        @endforeach
