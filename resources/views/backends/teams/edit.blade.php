...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{route('admin.teams.update',$id)}}" method="POST">
            @method('put')
            @csrf

            <div class="card">
                <div class="card-header" style="padding: 12px 20px;">
                    <h4 class="card-title">Edit Teams Members</h4>
                </div>
                    ...
                    <div class="basic-form">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('fb_link')) error-border-for-validation @endif" placeholder="Enter facebook link" name="fb_link" value="{{$data->fb_link}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('twiter_link')) error-border-for-validation @endif" placeholder="Enter twitter link" name="twiter_link" value="{{$data->twiter_link}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('linkedin_link')) error-border-for-validation @endif" placeholder="Enter linkedin link" name="linkedin_link" value="{{$data->linkedin_link}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('instagram_link')) error-border-for-validation @endif" placeholder="Enter instagram link" name="instagram_link" value="{{$data->instagram_link}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                @if($data->image != "")
                                    <img src="{{asset('uploads/teams/'.$data->image)}}" height="70" width="70" style="margin-top: 10px">
                                @endif
                            </div>
