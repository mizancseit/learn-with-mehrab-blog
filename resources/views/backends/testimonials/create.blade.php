                    ...
                    <div class="basic-form">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('customer_name')) error-border-for-validation @endif" placeholder="Enter name" name="customer_name" value="{{old('customer_name')}}" >
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control form-control-sm @if($errors->has('comments')) error-border-for-validation @endif" name="comments" rows="10">{{old('comments')}}</textarea>
