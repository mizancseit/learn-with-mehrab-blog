        ...
        <form action="{{route('admin.batches.store')}}" method="POST">
            ...
            <div class="card">
                <div class="card-header" style="padding: 12px 20px;">
                    <h4 class="card-title">Add Course Batch</h4>
                </div>
                    ...
                    <div class="basic-form">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('batch_ID')) error-border-for-validation @endif" placeholder="Enter Batch ID" name="batch_ID" value="{{old('batch_ID')}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('batch_name')) error-border-for-validation @endif" placeholder="Enter Batch Name" name="batch_name" value="{{old('batch_name')}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="datetime-local" class="form-control form-control-sm @if($errors->has('start_time')) error-border-for-validation @endif" placeholder="Enter Start Time" name="start_time" value="{{old('start_time')}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="date" class="form-control form-control-sm @if($errors->has('first_class')) error-border-for-validation @endif" placeholder="Enter First Class" name="first_class" value="{{old('first_class')}}" >
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea class="form-control-sm form-control" name="schedule">{{old('schedule') != null ? old('schedule') : '[{"day":"Satharday","time":"রাত ৯:০০ থেকে ১০:০০"},{"day":"Friday","time":"রাত ৯:০০ থেকে ১০:০০"}]'}}</textarea>
                            </div>


                            <div class="mb-3 col-md-6">
                                <label class="form-label">Fee <span class="mandatory">*</span></label>
                                <input type="number" class="form-control form-control-sm @if($errors->has('fee')) error-border-for-validation @endif" placeholder="Enter Fee" name="fee" value="{{old('fee')}}" >
                                @if($errors->has('fee'))
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="number" class="form-control form-control-sm @if($errors->has('discount')) error-border-for-validation @endif" placeholder="Enter Discount" name="discount" value="{{old('discount') != null ? old('discount') : 0}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="number" class="form-control form-control-sm @if($errors->has('advanced')) error-border-for-validation @endif" placeholder="Enter Advanced" name="advanced" value="{{old('advanced') != null ? old('advanced') : 0}}" >
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control form-control-sm @if($errors->has('status')) error-border-for-validation @endif" name="status">
                                    @foreach($batchStatus as $signle_batchStatus)
                                        <option value="{{$signle_batchStatus->value}}">{{$signle_batchStatus->name}}</option>
                                    @endforeach
                                </select>
