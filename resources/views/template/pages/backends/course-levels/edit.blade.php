...
@section('title','Edit Course Levels')
@section('page_heading','Course Level')

@section('content')
    <div class="container-fluid">
        @include('backends.includes.notification')

        <form action="{{route('admin.course-levels.update',$id)}}" method="POST">
            @method('put')
            @csrf

            <div class="card">
                <div class="card-header" style="padding: 12px 20px;">
                    <h4 class="card-title">Edit Course Level</h4>
                </div>
