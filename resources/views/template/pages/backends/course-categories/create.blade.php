                    ...
                    <div class="basic-form">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('icon')) error-border-for-validation @endif" placeholder="Enter icon" name="icon" value="{{old('icon')}}" >
                            </div>
