...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{route('admin.course-content-details.update',$id)}}" method="POST">
            @method('put')
            @csrf
            <div class="card">
                    ...
                    <div class="basic-form">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="js-example-basic-single form-control form-control-sm @if($errors->has('course_content_id')) error-border-for-validation @endif" name="course_content_id">
                                    ...
                                    @foreach($courseContents as $course_content)
                                        <option value="{{$course_content->id}}" @if($course_content->id == $data->course_content_id) selected @endif >{{$course_content->course?->title}} | {{$course_content->id}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm @if($errors->has('icon')) error-border-for-validation @endif" placeholder="Enter Icon" name="icon" value="{{$data->icon}}" >
                            </div>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control-sm form-control" name="subtitle" rows="5">{{$data->subtitle}}</textarea>
                            </div>

                            <div class="mb-3 col-md-12">
                                <label class="form-label">Description </label>
                                <textarea class="form-control form-control-sm" name="details">{!! $data->description !!}</textarea>
                            </div>
