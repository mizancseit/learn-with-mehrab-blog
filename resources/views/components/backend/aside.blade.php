<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="menu-title">SOFTWARE MENU</li>
{{--            @foreach($userComponents as $component)--}}
{{--                <li><a href="{{url($component->action)}}" class="" aria-expanded="false">--}}
{{--                        <div class="menu-icon">--}}
{{--                            {!! $component->icons !!}--}}
{{--                        </div>--}}
{{--                        <span class="nav-text">{{$component->professional_name}}</span>--}}
{{--                    </a>--}}
{{--                </li>--}}
{{--            @endforeach--}}
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{route('blog-posts.index')}}">Blog Post</a></li>
                </ul>
            </li>
...
{{--                </a>--}}
{{--                <ul aria-expanded="false">--}}
{{--                    <li><a href="{{route('blog-categories.index')}}">Add Services</a></li>--}}
{{--                    <li><a href="{{route('blog-posts.index')}}">Services List</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
...
{{--                </a>--}}
{{--                <ul aria-expanded="false">--}}
{{--                    <li><a href="{{route('admin.pricing-categories.index')}}">Pricing Categories</a></li>--}}
{{--                    <li><a href="{{route('admin.pricing.index')}}">Pricing List</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
...
{{--                </a>--}}
{{--                <ul aria-expanded="false">--}}
{{--                    <li><a href="{{route('admin.teams.create')}}">Add Team Member</a></li>--}}
{{--                    <li><a href="{{route('admin.teams.index')}}">Team Members List</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
...
{{--            </li>--}}
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('admin.contact-messages.index')}}">Message List</a></li>
                </ul>
            </li>
...
{{--                    <li><a href="{{route('blog-posts.index')}}">Blog Post</a></li>--}}
{{--                    <li><a href="{{route('blog-tags.index')}}">Blog Tag</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('admin.course-categories.index')}}">Course Category</a></li>
                    <li><a href="{{route('admin.course-levels.index')}}">Course Level</a></li>
                    <li><a href="{{route('admin.courses.index')}}">Course</a></li>
                    <li><a href="{{route('admin.course-contents.index')}}">Course Content</a></li>
                    <li><a href="{{route('admin.course-content-details.index')}}">Course Content Details</a></li>
                    <li><a href="{{route('admin.course-teachers.index')}}">Course Teachers</a></li>
                    <li><a href="{{route('admin.batches.index')}}">Batches</a></li>
                    <li><a href="{{route('admin.course-students.index')}}">Course Students</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{route('admin.webinar-students.index')}}">Register Students</a></li>
                </ul>
            </li>


            <li><a href="#" onclick="submitLogout()" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
